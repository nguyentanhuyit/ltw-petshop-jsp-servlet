...
@WebServlet(name = "UpdateImagePhotoUserServlet", urlPatterns = "/updateImageUser")
public class UpdateImageUserServlet extends HttpServlet {
    private static final String UPLOAD_DIRECTORY = "user/img"+ File.separator+"avatar";
