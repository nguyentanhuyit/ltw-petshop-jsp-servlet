...
@WebServlet(name = "UploadImageCategoryServlet", urlPatterns = "/uploadImageCategory")
public class UploadImageCategoryServlet extends HttpServlet {
    private static final String UPLOAD_DIRECTORY = "user/img"+ File.separator+"categories";
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                for (FileItem item : formItems) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        request.setAttribute("ImagePath", ava);
