        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form class="login100-form validate-form" action="signup" method="post">
                ...
                <div class="wrap-input100 validate-input m-b" style="    margin: 20px 0 20px 0">
                    ...
                    <input class="input100 input-pass-confirm" type="password" name="pass-confirm" placeholder="Xác nhận mật khẩu">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                </div>
                ...
                <div class="row validate-input">
                    ...
                    <div class="input-group">
                        ...
                        <label for="terms">Tôi chấp nhận các điều khoản và điều kiện để đăng ký dịch vụ này và qua đây xác nhận rằng tôi đã đọc chính sách bảo mật.</label>
                    </div>
                </div>
