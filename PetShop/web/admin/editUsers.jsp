                ...
                <section class="panel">
                    ...
                    <div class="body-content">
                        ...
                        <div class="avatar-upload">
                            ...
                            <form action="updateImageUser?account_id=<%=account.getAccount_id()%>" method="post" enctype="multipart/form-data" name="uploadImageUserForm">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal bucket-form" method="post" action="editUser" name="addUserForm">
                                ...
                                <%}%>
                                <input type="hidden" value="<%=account.getAccount_id()%>" name="account_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="role" class="form-control m-bot15" name="role_name">
                                            <option><%=RoleDAO.getRoleName(account.getAccount_id())%></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="user_name" type="text" class="form-control" name="user_name" value="<%=account.getUser_name()%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="password" class="col-lg-2 col-sm-2 control-label">Password</label>
                                    <div class="col-sm-10">
                                        <input id="password" type="password" class="form-control" name="password" value="<%=account.getPass()%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="account_name" class="col-lg-2 col-sm-2 control-label">Họ tên</label>
                                    <div class="col-sm-10">
                                        <input id="account_name" type="text" class="form-control" name="account_name" value="<%=account.getAccount_name()%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="gender" class="form-control m-bot15" name="gender">
                                            <option><%=account.getGender()%></option>
                                            <option>Nam</option>
                                            <option>Nữ</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="birthday" type="date" class="form-control" name="birthday" value="<%=account.getBirthday()%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="phone_num" class="col-lg-2 col-sm-2 control-label" title="Số điện thoại">SĐT</label>
                                    <div class="col-sm-10">
                                        <input id="phone_num" type="text" class="form-control" name="phone_num" value="<%=account.getPhone_num()%>">
                                    </div>
                                </div>
                                <div class="form-group">
