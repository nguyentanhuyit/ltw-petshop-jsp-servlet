                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6">
                        ...
                        <div class="checkout__order">
                            ...
                            <div class="checkout__order__products">Tên KH: <span><input type="text" placeholder="${account.user_name}" name="account_name_edit"></span></div>
                            <div class="checkout__order__products">Địa chỉ: <span><input type="text" placeholder="${account.address.address_detail}, ${account.address.district}, ${account.address.province}" name="address_edit"></span></div>
                    ...
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="checkout__order">
                            ...
                            <div class="checkout__order__subtotal checkout__order__total">Phí đặt cọc(10%)
                                <span>${Cart.currencyFormat(total*0.1)}đ</span></div>
                            <div class="checkout__order__subtotal checkout__order__total">

                                <button type="submit" class="site-btn" style="width: 100%; tchext-align: center">XÁC NHẬN</button>
