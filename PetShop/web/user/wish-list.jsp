            ...
            <div class="col-lg-12">
                <div class="shoping__cart__table">
                    <table>
                        ...
                        <tbody>
                        <c:forEach items="${listPet}" var="listPet">
                        <tr>
                            <td class="shoping__cart__item">
                                <img src="${listPet.photo.photo_main}" alt="">
                                <h5>${listPet.petName}</h5>
                            </td>
                            ...
                            <td>
                                <div class="add-to-card">
                                    <span class="card"><a href="shoping-cart.html"><i class="fa fa-shopping-bag"></i>&emsp;Thêm vào giỏ hàng</a></span>
                                </div>
                            </td>
